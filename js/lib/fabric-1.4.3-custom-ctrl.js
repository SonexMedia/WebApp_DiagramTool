...
// giryong area for rotation point
var imgObj    = new Image();

imgObj.src = "images/rotate1.png";

fabric.rotateIcon = imgObj;
  ...
  fabric.util.object.extend(fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
    ...
    drawControls: function(ctx) {
      ...
      var size = this.cornerSize,
          ...
          height = this.height,
          width = this.width,
          methodName = this.transparentCorners ? 'arc' : 'arc';
      ...
      this._drawControl('tl', ctx, methodName,
        left - paddingX,
        top - paddingY, size, 0, 2 * Math.PI, false);
      ...
      this._drawControl('bl', ctx, methodName,
        left - paddingX,
        top + height + paddingY, size, 0, 2 * Math.PI, false);
      ...
      if (!this.get('lockUniScaling')) {
        ...
        this._drawControl('mr', ctx, methodName,
          left + width + paddingX,
          top + height/2, size, 0, 2 * Math.PI, false);
      ...
      if (this.hasRotatingPoint) {
        this._drawControl('mtr', ctx, methodName,
          left + width/2 - 12,
          this.flipY
            ? (top + height + (this.rotatingPointOffset / this.scaleY) + paddingY - 12)
            : (top - (this.rotatingPointOffset / this.scaleY) - paddingY - 12), 10, 0, 2 * Math.PI, false);
      }
     ...
     * @private
     */
    _drawControl: function(control, ctx, methodName, left, top, radius, angle1, angle2) {
      ...
      if (this.isControlVisible(control))
      {
        ...
        // ctx[methodName](left, top, sizeX, sizeY, radius, angle1, angle2);
        ctx.save();
        ctx.beginPath();

        if(control == "mtr")
        {
            ctx.drawImage(fabric.rotateIcon, left, top);
        }
        else
        {
